...
export const COURSE_CONTENT_REGISTRY: Record<string, CourseContentEntry> = {
  ...
  "module-1-brief-history": {
    ...
    question: "Why did AI suddenly feel urgent for businesses around 2022–2023, and what actually changed?",
  ...
  "module-9-module-overview-section-card": {
    ...
    explanation: "The fragmented AI stack problem is extremely common and doesn't require a painful all-at-once consolidation to address. A practical rationalization approach has four steps. First, audit without judgment: catalog every AI tool in use, its purpose, its cost, its data handling practices, and its active user count. Don't ban anything during the audit — you need accurate information, which disappears if people fear the consequences of disclosure. Second, categorize: group tools by function and identify where you have three tools solving the same problem and where you have critical gaps. Third, establish a primary stack of 3–5 platforms that cover 80%+ of organizational needs, and create a clear timeline for migrating off redundant tools — not immediately, but with a committed end date. Fourth, implement a governance gate for all new tool requests: a lightweight evaluation checklist (purpose, integration, data handling, cost, approved alternative available?) that takes 30 minutes rather than six weeks. The goal is preventing future fragmentation, not punishing past decisions.",
  },
