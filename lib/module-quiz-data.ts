...
export const moduleQuizData = {
  ...
  "module-5": [
    {
      key: "quiz1",
      prompt: "What is the strongest definition of AI ROI in this course?",
      explanation: "AI ROI compares measurable business value created against total AI-related cost, including implementation effort.",
      correctOptionId: "b",
      options: [
        { id: "a", label: "Any time savings from using an AI tool", explanation: "Time savings help, but ROI also includes quality effects, business outcomes, and all costs." },
        { id: "b", label: "Net value gained from AI outcomes relative to full AI costs" },
        { id: "c", label: "How many prompts your team sends each day", explanation: "Prompt volume is an activity metric, not a return metric." },
      ],
    },
    {
      key: "quiz2",
      prompt: "Which metric set best measures AI effectiveness for customer support?",
      explanation: "First-contact resolution and customer satisfaction reflect customer-facing impact more directly than activity metrics.",
      correctOptionId: "c",
      options: [
        { id: "a", label: "Prompt count and total tokens used", explanation: "Those are usage metrics. They do not prove customer impact." },
        { id: "b", label: "Number of internal AI demos completed", explanation: "Demo count tracks activity, not operational effectiveness." },
        { id: "c", label: "First-contact resolution and customer satisfaction trend" },
      ],
    },
    {
      key: "quiz3",
      prompt: "Which category is a valid form of AI value creation?",
      explanation: "AI value usually appears through revenue gains, cost reduction, quality improvement, or risk reduction.",
      correctOptionId: "a",
      options: [
        { id: "a", label: "Lower error rates in a high-stakes workflow" },
        { id: "b", label: "Longer AI responses in every output", explanation: "Longer outputs can increase cost and noise without increasing value." },
        { id: "c", label: "Using the most expensive model by default", explanation: "Price does not guarantee return. Outcome impact matters more than cost tier." },
      ],
    },
    {
      key: "quiz4",
      prompt: "An AI pilot creates $3,000 in value and costs $1,000. What is ROI?",
      explanation: "ROI = ((Value - Cost) / Cost) * 100. Here that is ((3000 - 1000) / 1000) * 100 = 200%.",
      correctOptionId: "c",
      options: [
        { id: "a", label: "50%", explanation: "That would underestimate net benefit. Net value here is $2,000 on a $1,000 cost base." },
        { id: "b", label: "100%", explanation: "100% would mean net value equals cost. Here net value is double the cost." },
        { id: "c", label: "200%" },
      ],
    },
    {
      key: "quiz5",
      prompt: "Which metric is most likely to be misleading on its own?",
      explanation: "Prompt volume can rise even while quality and outcomes decline, so it is not a reliable standalone impact metric.",
      correctOptionId: "a",
      options: [
        { id: "a", label: "Total prompts sent per week" },
        { id: "b", label: "Cycle time reduction with stable quality", explanation: "This ties efficiency to quality control, which is much more meaningful." },
        { id: "c", label: "Error-rate trend in production outputs", explanation: "Error-rate trend is a direct operational quality signal." },
      ],
    },
    {
      key: "quiz6",
      prompt: "A tool pilot scores high on impact but low on data security fit. What is the best next step?",
      explanation: "Strong adoption decisions require impact and risk controls. Address security gaps before scaling.",
      correctOptionId: "b",
      options: [
        { id: "a", label: "Roll out immediately due to high impact potential", explanation: "Scaling with unresolved security risk can create costly incidents." },
        { id: "b", label: "Run a constrained pilot while fixing data and security controls" },
        { id: "c", label: "Ignore security concerns if users are happy", explanation: "User excitement does not remove compliance and security obligations." },
      ],
    },
  ],
  "module-6": [
