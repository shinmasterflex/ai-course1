        ...
        <main {...explainerAttributes} className="flex-1 max-w-4xl mx-auto p-8">
          ...
          {isModuleQuizSection && questions.length > 0 && (
            <div className="mt-10 space-y-5">
              <h3 className="text-2xl font-semibold text-brand-indigo">Knowledge check</h3>
              <TextDisplay content="Use this check to validate what you learned before moving to the next module." />
              <ModuleQuiz
              ...
              {allQuizComplete ? (
                <Card className="p-4 border-brand-green/30 bg-brand-green/10 text-sm text-brand-indigo">
                  Check complete. You have validated readiness to apply this module in practice.
                </Card>
              ) : null}
            </div>
          )}
