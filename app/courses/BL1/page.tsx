/**
 * BL1 Course Dashboard Page
 * This is now the single entry point for the course dashboard UI.
 */
...
export default function BL1CourseDashboardPage() {
  // ...DashboardPage code from app/course/page.tsx...
