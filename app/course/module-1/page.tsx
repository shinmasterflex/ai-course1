          ...
          {currentSectionIndex === 2 && (
            <div className="space-y-6">
              ...
              <Slideshow slides={[
                ...
                { id: "2024", title: "2024 — AI learns to reason", content: "OpenAI released o1 — a model that 'thinks before it answers,' spending time reasoning step by step before producing a response. This dramatically improved performance on mathematics, coding, and complex logic problems.\n\nClaude 3 Opus matched or exceeded GPT-4 on many benchmarks. Meta released Llama 3 as open-source, making powerful AI available to anyone with a computer. The number of AI models multiplied from dozens to hundreds.\n\nAnd AI stopped being just a chat interface — it started taking actions: browsing the web, writing and running code, managing files. The era of AI agents had begun." },
                { id: "2025", title: "2025 — AI agents become real products", content: "OpenAI launched Operator — an AI agent that uses a real web browser to complete tasks for you. Anthropic's Claude gained 'computer use' capabilities, letting it click, type, and navigate just as a human would.\n\nDeepSeek R1, a Chinese open-source reasoning model, matched OpenAI's best models at a fraction of the cost — shocking the AI industry and sending technology stock prices tumbling.\n\nThe phrase 'vibe coding' entered the mainstream: developers describing what they wanted in plain English and AI writing the entire codebase. Software engineers who once spent days on a feature could now ship in hours.\n\nAI had stopped being a tool you talked to. It had become a collaborator that acts." },
                { id: "now", title: "Today — AI is everywhere and accelerating", content: "From medical diagnosis to music generation, legal research to software development — AI is woven into nearly every industry.\n\nThe models available today are more capable than anything that existed even one year ago. Capabilities that required specialist hardware in 2022 now run on a laptop.\n\nYou are living through one of the fastest technological shifts in human history — and you are taking this course right at the inflection point. What you learn here will be foundational whether AI accelerates, plateaus, or surprises everyone." },
              ]} />
              <FlipCard
