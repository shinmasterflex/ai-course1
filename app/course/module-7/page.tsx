    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-8 max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">Module 7: AI Agents</h1>
          ...
          {currentSectionIndex === 7 && (
            <div className="space-y-6">
              ...
              {allQuizComplete && (
                <div className="space-y-4">
                  <TextDisplay variant="success" content="Excellent work  - you have completed Module 7: AI Agents. You now understand what agents are, how they work, the main types, where they are deployed, how to build them, and the risks to manage. You are equipped to think critically and practically about the most transformative shift in AI today." />
                  
                  <div className="flex gap-4">
                    <Button
                      size="lg"
                      className="bg-brand-orange hover:bg-brand-orange/90 text-white"
                      onClick={() => router.push("/course/module-8")}
                    >
